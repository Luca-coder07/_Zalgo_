...
[✅] Interpolation linéaire (Lerp) : Transition douce entre deux valeurs

[✅] Interpolation sinusoïdale (Smoothstep) : Accélération/décélération naturelle
...
[✅] Navigation par waypoints : Déplacement entre points prédéfinis

### GESTION DU TEMPS ET DU JEU

[✅] Delta time : Calcul du temps écoulé entre frames

[✅] Système de timer réutilisable : Compte à rebours pour effets temporaires

[✅] Curve easing : Fonctions d'accélération (quadratique, cubique, exponentiel)
